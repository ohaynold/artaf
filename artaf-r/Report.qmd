...
by aerodrome. There is an interest West-to-East gradient in reversion of
increases:
...
in predicted visbility than for increases with a reversion coefficient of `r format(-coef(visibility_lm)[1], digits=3)` for increases
