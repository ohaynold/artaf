...
(semi-, since they are reported as integers with rounding) continuous variables 
...
of their changes in a later TAF. As a first approximation, for quite a few variables, the 
...
pessimistic than for other variables.
...
others. For worsening predictions, we see some tendencies different
